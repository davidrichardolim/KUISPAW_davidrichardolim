                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-header bg-light border-bottom py-3 d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0 fw-bold text-dark">
                            <i class="bi bi-info-circle text-primary me-2"></i>Detail Program Studi
                        </h5>
                        <a href="/prodi" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="card-body p-4">
                        ...
                        <!-- Baris 3: Nama Kaprodi -->
                        <div class="row mb-2">
                            <div class="col-sm-4 text-secondary fw-semibold">
                                Nama Ketua Prodi (Kaprodi)
                            </div>
                            <div class="col-sm-8 text-dark">
                                {{ $prodi->nama_kaprodi }}
                            </div>
                    ...
                    <div class="card-footer bg-white border-top py-3 d-flex justify-content-end gap-2">
                        <a href="/prodi/{{ $prodi->id }}/edit" class="btn btn-warning text-white px-3 shadow-sm">
